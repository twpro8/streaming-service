...
Revision ID: 97965ac8b4fd
Revises:
Create Date: 2025-08-30 17:11:36.242770
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "first_name", "last_name", "birth_date", name="uq_actor"
        ),
    )
    op.create_table(
        "comments",
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("user_id", "content_id", name="uq_rating"),
    )
    op.create_table(
        "shows",
        sa.Column("id", sa.UUID(), nullable=False),
